    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <button><a href="blockchainLexiconEn.html">English</a></button>  
                <h1 style="color: #FF797C;">Léxique de la Chaîne de bloc</h1>  
                ...
                <table>
                    ...
                    <xsl:for-each select="tmx/body/tu/tuv[@xml:lang='fr']">
